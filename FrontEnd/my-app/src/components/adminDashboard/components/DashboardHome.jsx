  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [hrsResponse, employeesResponse, clientsResponse] = await Promise.all([
        fetch('http://localhost:8080/admin/dashboard/total-hrs', {
          credentials: 'include'
        }),
        fetch('http://localhost:8080/admin/dashboard/total-employees', {
          credentials: 'include'
        }),
        fetch('http://localhost:8080/admin/dashboard/total-clients', {
          credentials: 'include'
        })
      ]);
